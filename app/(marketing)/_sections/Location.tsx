...
export default function LocationSection() {
  return (
    <section className="container rounded-xl p-8 md:py-12 lg:py-24">
      <div className="mx-auto flex w-full flex-col items-center justify-center gap-4 text-center lg:w-4/5 ">
